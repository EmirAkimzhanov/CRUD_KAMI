...
export default function NavBar() {
  ...
  const { city, setCity } = useProducts();
          ...
          >
            ...
            <div>
              ...
              >
                ...
                >
                  <Button onClick={() => handleSet("almaty")}>Almaty</Button>
                  <Button onClick={() => handleSet("astana")}>Astana</Button>
                  <Button onClick={() => handleSet("nursultan")}>
                    Nursultan
                  </Button>
                  <Button onClick={() => handleSet("szymkent")}>
                    Szymkent
                  </Button>
                </Box>
              </Popper>
